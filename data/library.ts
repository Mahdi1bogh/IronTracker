...
export const DEFAULT_LIBRARY: LibraryExercise[] = [
    ...
    },
    {
      ...
      "muscle": "Épaules",
      "equipment": "DB",
      "tips": { "setup": ["Banc à 90°", "Dos plaqué", "Pieds ancrés"], "exec": ["Pousser vers le plafond", "Contrôler la descente oreilles"], "mistake": ["Cambrer le bas du dos excessivement", "Descendre trop bas"] }
    },
    {
    ...
    },
    {
      ...
      "muscle": "Jambes",
      "equipment": "BB",
      "tips": { "setup": ["Pieds largeur hanches, barre contre tibias", "Mains largeur épaules"], "exec": ["Pousser le sol avec les jambes", "Dos plat, barre colle au corps"], "mistake": ["Arrondir le dos (dos rond)", "Tirer avec les bras"] }
    },
    {
